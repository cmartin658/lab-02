...
author: "Team Name: Carla, Maia, Selena, Kumi"
date: "`r Sys.Date()`"
...
plastic_data_all %>% 
  grouped_by_region <- count(region, sort = TRUE)
...
plastic_data_all %>% mutate(total_mismanaged_plastic=mismanaged_plastic*population) %>%
